...
public class Session implements Serializable {
	...
	private String account;// session绑定的账号 对应数据库userId
	...
	public boolean write(Object msg) {
		...
		if (session != null && isConnected()) {
			...
			try {
				...
				/*
				 * MessageProto.Model msgModel = (MessageProto.Model)msg; ScriptBuffer script =
				 * new ScriptBuffer(); Object json = JSONArray.toJSON(msgModel.toByteArray());
