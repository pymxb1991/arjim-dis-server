...
public class RedisDao {
    ...
    public static boolean expire(String key, long time) {
        try {
            return time > 0 ? myRedisTemplate.expire(key, time, TimeUnit.SECONDS) : false;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static long getExpire(String key) {
        return key != null ? myRedisTemplate.getExpire(key, TimeUnit.SECONDS) : null;
    }
    ...
    public static boolean hasKey(String key) {
        try {
            return key != null ? myRedisTemplate.hasKey(key) : false;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static void deleteByPrex(String prex) {
        Set<String> keys = myRedisTemplate.keys(prex + "*");
...
//-----------------------------------------------Hash 哈希类型相关操作 ------------------------------------------
    ...
    public static Object hget(String key, String item) {
        ...
        return (key != null && item != null) ? myRedisTemplate.opsForHash().get(key, item) : null;
    }
    ...
    public static Map<Object, Object> hmget(String key) {
        return key != null ? myRedisTemplate.opsForHash().entries(key) : null;
    }
    ...
    public static boolean hset(String key, String item, Object value) {
        try {
            if (key == null || item == null || value == null) return false;
    ...
    public static boolean hHasKey(String key, String item) {
        return (key != null && item != null) ? myRedisTemplate.opsForHash().hasKey(key, item) : false;
    }
...
// --------------------------------------- SET类型相关操作 -------------------------------------------
    ...
    public static Set<Object> sGet(String key) {
        try {
            return key != null ? myRedisTemplate.opsForSet().members(key) : null;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean sHasKey(String key, Object value) {
        try {
            return (key != null && value != null) ? myRedisTemplate.opsForSet().isMember(key, value) : false;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static long sSet(String key, Object... values) {
        try {
            return (key != null && values != null) ? myRedisTemplate.opsForSet().add(key, values) : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public static long sSetAndTime(String key, long time, Object... values) {
        try {
            if(key == null || values ==null) return 0;
    ...
    public static long sGetSetSize(String key) {
        try {
            return key!=null ? myRedisTemplate.opsForSet().size(key) : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
