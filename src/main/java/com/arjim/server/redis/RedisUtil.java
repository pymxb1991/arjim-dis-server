...
public class RedisUtil {
    ...
    public Set<String> hasKeyByPrefix(String key) {
    ...
    public <T> T  getJson(String key,Class<T> clazz) {
        ...
        key = (String)redisTemplate.opsForValue().get(key);
        return (T) JSONObject.parseObject(key, clazz);
    }
