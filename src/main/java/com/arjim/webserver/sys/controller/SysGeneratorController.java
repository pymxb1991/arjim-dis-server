 ...
 ***************************************************************************************
 */
package com.arjim.webserver.sys.controller;
...
import com.arjim.webserver.sys.service.SysGeneratorService;
...
public class SysGeneratorController extends BaseController {
	 ...
	 */
	@RequestMapping("/code")
	public void code(@RequestParam String[] tables, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		// 获取表名，不进行xss过滤
