...
import com.arjim.webserver.sys.model.ColumnEntity;
import com.arjim.webserver.sys.model.TableEntity;
...
public class GenUtils {
	...
	public static String getFileName(String template, String className, String packageName) {
		...
		if (template.contains("list.js.vm")) {
			return "main" + File.separator + "webapp" + File.separator + "js" + File.separator + "generator"
