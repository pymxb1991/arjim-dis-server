...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    c.prototype.config = function (i) {
        ...
        if (layui.each(Array(5), function (i) {
            a.push(layui.cache.dir + "css/modules/arjim/skin/" + (i + 1) + ".jpg")
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({
            ...
            offset: "rb",
            resize: !1,
            content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/pc/arjim/skin/logo.jpg") + '"><span>' + (i || j.base.title || "我的LayIM") + "</span>",
        ...
        i.css({
            "background-image": e ? "url(" + e + ")" : function () {
                return j.base.initSkin ? "url(" + (layui.cache.dir + "css/modules/arjim/skin/" + j.base.initSkin) + ")" : "none"
            }()
        })
    }, $ = function (i) {
        ...
        var i = {
            ...
            avatar: j.mine ? j.mine.avatar : layui.cache.dir + "css/pc/arjim/skin/logo.jpg",
        ...
        if (!(l.ie && l.ie < 9)) {
            ...
            i.src = layui.cache.dir + "css/modules/arjim/voice/" + j.base.voice, i.play()
        }
    }, G = {}, K = function (i) {
        i = i || {};
        ...
        status: function (i, a) {
            ...
            t.alert("版本： " + a + '<br>版权所有：<a href="" target="_blank"> </a>', {title: "关于 LayIM", shade: !1})
        }, setSkin: function (i) {
            ...
            layui.each(r.setSkin, function (i, e) {
                var t = (a || "").replace(layui.cache.dir + "css/modules/arjim/skin/", "");
                e && e(t, a)
            })
        }, chat: function (i) {
    ...
    i("layim", new c)
}).addcss("modules/arjim/layim.css?v=3.7.6", "skinlayimcss");